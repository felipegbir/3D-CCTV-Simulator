...
for marker in ('N.O.M.A.D. CCTV Digital Twin Simulator 8e.7.4','id="appVersionLabel">8e.7.4','id="menuVersionLabel">8e.7.4','href="/static/user-guide.html"','id="openUserGuide"','/static/viewer.js?v=874'):
...
for marker in ('Version 8e.7.4','id="projects"','id="cameras"','id="ptz"','id="roi"','id="measure"','id="wall"','id="reports"','Lay Face Flat remains experimental'):
